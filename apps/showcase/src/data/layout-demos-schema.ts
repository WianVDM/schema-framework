    ...
    },
    {
      ...
      content: {
        ...
        schema: {
          ...
          fields: [
            { name: 'street', label: 'Street', type: 'text', placeholder: 'Enter street address' },
      ...
      content: {
        ...
        schema: {
          ...
          fields: [
            ...
            { name: 'minPrice', label: 'Min Price', type: 'text', placeholder: '$0' },
            { name: 'maxPrice', label: 'Max Price', type: 'text', placeholder: '$1000' },
          ],
          submitLabel: 'Apply',
        },
      },
  ...
  regions: [
    {
      ...
      content: {
        ...
        schema: {
          title: 'Search',
          fields: [
            { name: 'query', label: 'Search', type: 'text', placeholder: 'Search items...' },
          ],
          submitLabel: 'Search',
        },
      },
