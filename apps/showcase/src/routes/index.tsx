		...
		<div className="max-w-2xl mx-auto">
			...
			<div className="grid gap-4">
				...
				<div className="border rounded-lg p-4">
					...
					<p className="text-sm text-muted-foreground">
						Define your UI with JSON schemas. The engine renders forms, tables,
						and fields automatically.
					</p>
				</div>
				<div className="border rounded-lg p-4">
					<h3 className="font-semibold mb-2">shadcn/ui Integration</h3>
					<p className="text-sm text-muted-foreground">
						Uses the PrimitivesContext pattern so core stays decoupled from
