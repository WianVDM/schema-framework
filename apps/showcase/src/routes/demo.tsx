  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-muted-foreground mb-6">
        Explore the schema-driven engine with these interactive demos. Each demo is rendered from a
        JSON schema definition.
      </p>
      <div className="grid gap-4 sm:grid-cols-2">
        <Link to="/demo-form" className="border rounded-lg p-6 hover:bg-muted/50 transition-colors">
        ...
        <Link to="/demo-grid" className="border rounded-lg p-6 hover:bg-muted/50 transition-colors">
