import { PrimitivesProvider, SchemaForm } from '@my-framework/core'
  ...
  return (
    <div className="container mx-auto py-10 px-4 max-w-2xl">
      ...
      <p className="text-muted-foreground mb-8">
        Demonstrates the <code className="text-sm bg-muted px-1 py-0.5 rounded">multiselect</code>{' '}
        field type with predefined options, custom tag creation, selection limits, and default
        values.
      </p>
