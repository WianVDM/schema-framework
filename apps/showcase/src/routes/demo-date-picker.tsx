		...
		<div className="max-w-2xl mx-auto space-y-8">
			<div>
				...
				<p className="text-muted-foreground mb-6">
					Self-contained date picker using date-fns + react-day-picker. Layer 1
					primitive — no schema knowledge required.
				</p>
			</div>
			...
			<div className="space-y-4">
				...
				<p className="text-sm text-muted-foreground">
					Default format (yyyy-MM-dd). Type in the input or click the calendar
					icon.
				</p>
			...
			<div className="space-y-4">
				...
				<p className="text-sm text-muted-foreground">
					Min: 2025-01-01, Max: 2025-12-31. Dates outside range are disabled in
					the calendar.
				</p>
				<div className="max-w-xs">
					<DatePicker
