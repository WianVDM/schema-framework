...
export function TagInput({
	...
	const canCreate =
		creatable && inputValue.trim() !== "" && !exactMatch && !isAtLimit;
	...
	return (
		<div ref={containerRef} className="relative">
			{/* biome-ignore lint/a11y/useSemanticElements: compound tag-input widget — fieldset breaks inline-flex layout and adds unwanted default styling */}
			<div
				role="group"
