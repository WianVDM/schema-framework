...
export function Splitter({
	...
	useEffect(() => {
		...
		const initialSizesChanged =
			...
			JSON.stringify(prevInitialSizesRef.current);
			...
			{childArray.map((child, index) => {
				...
				return (
					<Fragment key={childKey}>
						...
						{index < panelCount - 1 && (
							// biome-ignore lint/a11y/useSemanticElements: interactive draggable separator with aria-valuenow/min/max cannot use <hr> — per WAI-ARIA Authoring Practices for interactive separators
							<div
