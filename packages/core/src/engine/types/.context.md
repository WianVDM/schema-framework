...
| runtime-validation-rule.ts | RuntimeValidationRule | interface | Runtime validation rule with optional validate callback |
...
| date-picker-config.ts | DatePickerConfig | interface | Date picker configuration |
| multi-select-config.ts | MultiSelectConfig | interface | Multi-select / tag input configuration |
...
| virtual-scroll-config.ts | VirtualScrollConfig | interface | Virtual scrolling configuration |
...
graph TD
    ...
    validation-rule.ts -->|uses-type| runtime-validation-rule.ts

    field-type.ts -->|uses-type| field-schema.ts
    select-option.ts -->|uses-type| field-schema.ts
    runtime-validation-rule.ts -->|uses-type| field-schema.ts
    field-condition.ts -->|uses-type| field-schema.ts
    file-upload-config.ts -->|uses-type| field-schema.ts
    date-picker-config.ts -->|uses-type| field-schema.ts
    multi-select-config.ts -->|uses-type| field-schema.ts
    select-option.ts -->|uses-type| multi-select-config.ts
    ...
    virtual-scroll-config.ts -->|uses-type| grid-schema.ts
    branded.ts -->|uses-type| grid-schema.ts
