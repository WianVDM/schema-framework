...
): content is ContentSchema & { readonly type: 'form'; readonly schema: FormSchema } {
...
export function isGridContent(
  content: ContentSchema,
): content is ContentSchema & { readonly type: 'grid'; readonly schema: GridSchema } {
...
export function isWizardContent(
  content: ContentSchema,
): content is ContentSchema & { readonly type: 'wizard'; readonly schema: WizardSchema } {
...
export function isTabsContent(
  content: ContentSchema,
): content is ContentSchema & { readonly type: 'tabs'; readonly schema: TabSchema } {
...
export function isLayoutContent(
  content: ContentSchema,
): content is ContentSchema & { readonly type: 'layout'; readonly schema: LayoutSchema } {
