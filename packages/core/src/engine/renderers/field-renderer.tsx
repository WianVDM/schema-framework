...
function renderFieldControl(
  ...
  switch (schema.type) {
    case 'select':
      return wrapper(renderSelectControl(schema, value, onChange, primitives, fieldId, ariaProps))
    case 'textarea':
      return wrapper(renderTextareaControl(schema, value, onChange, primitives, fieldId, ariaProps))
    case 'checkbox':
    ...
    case 'multiselect':
      return wrapper(
        renderMultiselectControl(schema, value, onChange, primitives, fieldId, ariaProps),
      )
    default:
      return wrapper(renderInputControl(schema, value, onChange, primitives, fieldId, ariaProps))
  }
}
  ...
  return (
    ...
    >
      <primitives.SelectTrigger id={fieldId} {...ariaProps}>
        <primitives.SelectValue placeholder={schema.placeholder ?? 'Select...'} />
