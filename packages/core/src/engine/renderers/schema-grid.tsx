...
export function SchemaGrid({
  ...
  const handleDragEnd = useCallback(
    ...
    [onColumnOrderChange, columnOrder, isColumnVisible],
  )
  ...
  const _shouldShowServerPagination = !!schema.serverPagination
  ...
  const _headerBorderClasses = schema.bordered ? 'border-r last:border-r-0' : ''
