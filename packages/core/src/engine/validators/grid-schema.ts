...
export const gridColumnSchemaValidator = z
  .object({
    key: z.string().min(1, 'Column key is required'),
    label: z.string().min(1, 'Column label is required'),
    type: z.enum(['text', 'number', 'date', 'boolean', 'status']).optional(),
...
export const gridSchemaValidator = z
  .object({
    title: z.string().optional(),
    description: z.string().optional(),
    columns: z.array(gridColumnSchemaValidator).min(1, 'Grid must have at least one column'),
    dataKey: z
      .string()
    ...
    pagination: z.union([paginationConfigSchema, z.boolean()]).optional(),
    filterable: z.boolean().optional(),
    resizable: z.boolean().optional(),
    columnVisibility: z.record(z.string(), z.boolean()).optional(),
    serverPagination: serverPaginationConfigSchema.optional(),
    i18n: i18nConfigSchema.optional(),
    virtualScroll: z.union([virtualScrollConfigSchema, z.boolean()]).optional(),
