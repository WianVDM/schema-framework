...
|------|-------------|-------------|-------------|
| shared-schemas.ts | fieldTypeSchema, paginationConfigSchema, columnFilterConfigSchema, statusConfigSchema, serverPaginationConfigSchema, i18nConfigSchema, virtualScrollConfigSchema, ValidationResult | const/type | Shared Zod schemas and result type |
