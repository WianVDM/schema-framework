...
|------|-------------|-------------|-------------|
| shared-schemas.ts | fieldTypeSchema, paginationConfigSchema, columnFilterConfigSchema, statusConfigSchema, serverPaginationConfigSchema, i18nConfigSchema, virtualScrollConfigSchema, multiSelectConfigSchema, ValidationResult | const/type | Shared Zod schemas and result type |
...
- `grid-schema.ts` --> imports `DataKey` from `../types/branded.ts`
