...
function checkPattern(value: unknown, rule: Readonly<RuntimeValidationRule>): string | null {
...
function checkCustom(value: unknown, rule: Readonly<RuntimeValidationRule>): string | null {
...
function applyRule(value: unknown, rule: Readonly<RuntimeValidationRule>): string | null {
